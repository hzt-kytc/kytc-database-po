...
public class TableDTO {
	...
	public String toString() {
		...
		builder.append("TableDTO [tableCatalog=");
		...
		builder.append(tableRows);
		builder.append(", avgRowLength=");
		builder.append(avgRowLength);
		builder.append(", dataLength=");
		builder.append(dataLength);
		builder.append(", maxDataLength=");
		builder.append(maxDataLength);
		builder.append(", indexLength=");
		builder.append(indexLength);
		builder.append(", dataFree=");
		builder.append(dataFree);
		...
		builder.append(checkTime);
		builder.append(", tableCollation=");
		builder.append(tableCollation);
		builder.append(", checksum=");
		builder.append(checksum);
		builder.append(", createOptions=");
		builder.append(createOptions);
